...
public class ProduktController {
    ...
    @GetMapping("/{id}")
    public ProduktDto produktNachId(@PathVariable Long id) {
        return toDto(produktService.produktNachId(id));
    }

    @PostMapping
    @ResponseStatus(HttpStatus.CREATED)
    public ProduktDto produktErstellen(@Valid @RequestBody ProduktErstellenDto dto) {
